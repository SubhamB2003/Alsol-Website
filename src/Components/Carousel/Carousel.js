        ...
        >
            <SwiperSlide>
                <div className='bg-gradient text-white'>
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 mt-5" aria-hidden="true">
                        <h4 className='text-5xl text-center font-bold'>Development</h4>
                        <p className='text-center font-medium my-8 text-lg md:px-32 px-10 pb-10'>We AlsolTech develop web application with effective UI/UX which are mobile first and user
                            friendly</p>
